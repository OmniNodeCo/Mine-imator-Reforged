...
function tab_template_editor_particles_preview()
{
	...
	if (ptype_edit.temp = particle_sheet)
	{
		...
		ani =  ptype_edit.sprite_frame_start = ptype_edit.sprite_frame_end ? 0 : real(particle_get_animation_percent(current_step, particle_editor_preview_start, ptype_edit.sprite_frame_start, ptype_edit.sprite_frame_end, particle_editor_preview_speed, ptype_edit.sprite_animation_onend))
