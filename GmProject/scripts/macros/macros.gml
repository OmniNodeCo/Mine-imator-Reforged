...
function macros()
{
	...
	#macro mineimator_version_sub		"Reforged 1.0.2"	// Mod name and version (e.g. "Community Build 1.0.0")
	...
	#macro link_fork_repo			"https://github.com/OmniNodeCo/Mine-imator"
