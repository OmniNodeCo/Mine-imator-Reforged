...
**Mine-imator Reforged 1.0.2** — based on Mine-imator 2.0.2.
...
| Reforged | 1.0.1 | 2026.09.07 |

The full in-app version reads `2.0.2 Reforged 1.0.2`. Platform file versions use `<base>.<build>`, e.g. `2.0.2.3`. See [CHANGELOG.md](CHANGELOG.md) for details.
